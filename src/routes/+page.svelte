...
<div class="hero">
    ...
    <div class="right">
        <div class="job">
            {#if $job[0].visible}
                <h1 in:fly="{{y:-100, delay: 500, duration: 300}}" out:fly="{{y: 100, duration: 300}}">
                    {$job[0].title + "."}
                </h1>
            {/if}
            {#if $job[1].visible}
...
<div class="jo">
    ...
    <div id="projects">
        ...
        images = {[{mobile:"src/routes/_assets/detour_phone_1.jpg", pc:"src/routes/_assets/detour_pc_1.jpg"}, {mobile:"src/routes/_assets/detour_phone_2.jpg", pc:"src/routes/_assets/detour_pc_2.jpg"}]}
        ...
        images = {[{mobile:"src/routes/_assets/syphilis_phone_1.png", pc:"src/routes/_assets/syphilis_pc_1.jpg"}, {mobile:"src/routes/_assets/syphilis_phone_2.png", pc:"src/routes/_assets/syphilis_pc_2.jpg"}]}
...
<style lang="sass">
    ...
    #contact
        ...
        grid-template-areas: "title words" "title words"
        padding-top: 100px
        height: 40vh
        h1
            grid-area: title
