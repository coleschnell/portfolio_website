<script>
  ...
  import MultiLine from '../memphis-based-banks/_components/MultiLine.svelte';
  import AxisX from '../memphis-based-banks/_components/AxisX.svelte';
  import AxisY from '../memphis-based-banks/_components/AxisY.svelte';
  import Labels from '../memphis-based-banks/_components/GroupLabels.html.svelte';
  import SharedTooltip from '../memphis-based-banks/_components/SharedTooltip.html.svelte';
  import RecessionBars from '../memphis-based-banks/_components/RecessionBars.svelte'
  import Area from '../memphis-based-banks/_components/Area.svelte'

  // This example loads csv data as json using @rollup/plugin-dsv
  import data from '../memphis-based-banks/_data/first_horizon_deposits.csv';
...
<div class="chart-container" style="margin: {margin.top}px {margin.right}px {margin.bottom + footnote_height + title_height}px {margin.left}px;">
  {#if title !== 'null'}
  <h3 class="chart-title" bind:clientHeight={title_height}>{title}</h3>
  {/if}
  <LayerCake
